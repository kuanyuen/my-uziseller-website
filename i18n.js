...
const I18N = {
  ...
  'subs.afterMarkup': { en: '30% margin included', zh: '已含30%加价' },
  'subs.viewBuy': { en: 'Details & Buy', zh: '详情并购买' },
  'subs.trySearch': { en: 'Try another keyword or category.', zh: '请尝试其他关键词或分类。' },
  ...
  'subs.markupNote': { en: 'Supplier price + 30%', zh: '供应商价格 +30%' },
